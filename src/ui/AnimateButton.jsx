...
const SocialLink = ({ icon, text, href, isBlank = true, isLarge = false }) => {
  return (
    <motion.a
      href={href}
      ...
      className={`inline-flex relative group items-center justify-center ${
        isLarge
          ? "text-sm px-4 py-3 font-semibold"
