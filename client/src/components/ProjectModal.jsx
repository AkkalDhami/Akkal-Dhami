      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed min-w-full min-h-screen h-full inset-0 z-50 flex items-center justify-center p-4 bg-bg-900 backdrop-blur-[2px]"
            onClick={closeModal}>
            <motion.div
              ...
              <motion.div
                className="sticky top-0 bg-bg-900 bg-opacity-80 rounded-lg backdrop-blur-md p-4 flex  justify-between items-center z-50"
                initial={{ y: -50 }}
                animate={{ y: 0 }}
      ...
      <AnimatePresence>
        {fullscreenImage && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 bg-bg-900 bg-opacity-95 flex items-center justify-center p-4"
